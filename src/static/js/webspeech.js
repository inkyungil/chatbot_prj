...
//
  ...
  if (!('webkitSpeechRecognition' in window)) {
    ...
    r.recognition.onresult = function(event) {
      r.interim_transcript = '';
       r.final_transcript = event.results[event.resultIndex][0].transcript;
...
var image_array_mic = {
  'ready' : '/chat/images/icon-mic.gif',
  'complete' : '/chat/images/icon-mic.gif',
  'active' : '/chat/images/icon-mic-animate.gif',
  'no-speech' : '/chat/images/icon-mic.gif',
  'disable' : '/chat/images/icon-mic-slash.gif'
};
